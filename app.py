...
DESCRIPTOR_API3_RES = _descriptor_pool.Default().AddSerializedFile(b'\n\x13MajorLoginRes.proto\"|\n\rMajorLoginRes\x12\x13\n\x0b\x61\x63\x63ount_uid\x18\x01 \x01(\x04\x12\x0e\n\x06region\x18\x02 \x01(\t\x12\r\n\x05token\x18\x08 \x01(\t\x12\x0b\n\x03url\x18\n \x01(\t\x12\x11\n\ttimestamp\x18\x15 \x01(\x03\x12\x0b\n\x03key\x18\x16 \x01(\x0c\x12\n\n\x02iv\x18\x17 \x01(\x0c\x62\x06proto3')
_globals2 = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR_API3_RES, _globals2)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR_API3_RES, 'MajorLoginRes_pb2', _globals2)
...
# ==========================================
# HELPER FUNCTIONS (API 2 & 3)
# ==========================================
def pad_aes_api2(text: bytes) -> bytes:
    padding_length = 16 - (len(text) % 16)
    return text + bytes([padding_length] * padding_length)

def encrypt_aes_api2(plaintext: bytes) -> bytes:
    cipher = AES.new(AES_KEY, AES.MODE_CBC, AES_IV)
    return cipher.encrypt(pad_aes_api2(plaintext))

def encrypt_aes_api3(data: bytes) -> bytes:
    cipher = AES.new(AES_KEY_INT, AES.MODE_CBC, AES_IV_INT)
